#!/usr/bin/env python3
# Copyright (c) 2026 Andrea Maiorana.
# Original source:
# https://github.com/rufio72/kobon_triangles_k14/blob/e47c7cfd9661e54d29befb83118bf83d5f804028/verify_direct_exact.py
# Licensed under CC BY 4.0; see CC-BY-4.0.txt in this directory.
# Modified for kobon-solutions: the expected triangle count is read from the
# certificate field "triangle_count" instead of the original field "count".
# The verification algorithm is otherwise unchanged.
